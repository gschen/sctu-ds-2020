    ...
    def delete(self,item):
        ...
        if parent:
            ...
            if del_node.left is None:
                ...
                tmp_pre = del_node
                tmp_text = del_node.right
                if tmp_text.left is None:
                    tmp_pre.right = tmp_text.right
                    tmp_text.left = del_node.left
                    tmp_text.right = del_node.right
                else:
                    while tmp_text.left:# 将tmp指向右子树的最后一个节点
                        tmp_pre = tmp_text
                        tmp_text = tmp_text.left
                    tmp_pre.left = tmp_text.right
                    tmp_next.left = del_node.left
                    tmp_text.right = del_node.right
                if parent.left.item == item:
                    parent.left = tmp_text
                else:
                    parent.right = tmp_text
                del del_node
                return True
            return False
