class Node(object):
    def __init__(self, item):
        ...
        self.right = None
    def __str__(self):
        return str(self.item)#print一个Node类时会打印—str_的返回值
...
class Tree(object):
    ...
    def add(self, item):
        ...
        if self.root is None:#如果二叉树为空，那么生成的二叉树最终为新插入树的点
            ...
            while True:
                pop_node = q.pop(0)
                if pop_node.left is None:#如果左子树为空，则将该点添加在左子树
                    pop_node.left = node
                    return
                elif pop_node.right is None:#如果右子树为空，则将该点添加在右子树
                    pop_node.right = node
                    return
                else:
        ...
        if parent:
            ...
            if del_node.left is None:
                ...
                if tmp_next.left is None:
                    ...
                    while tmp_next.left:#将tmp指向右子树的最后一节点
                        tmp_pre = tmp_next
