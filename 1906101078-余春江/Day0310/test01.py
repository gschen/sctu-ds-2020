...
class Game():
    ...
    def playGame(self):
        for i in range(self.number):
            ...
            if a_out==b_out:
                print("双方平局，出的事{}".format(a_out))
            elif (a_out=="石头" and b_out=="剪刀") or (a_out=="布" and b_our=="石头") or (a_out=="剪刀" and b_out=="布"):
                self.a.score+=1
                print("{}获得胜利，出的事{}，{}出的事{}".format(self.a.name,a_out,self.b.name,b_out))
            else:
                self.b.score+=1
                print("{}获得胜利，出的事{}，{}出的事{}".format(self.b.name,b_out,self.a.name,a_out))
